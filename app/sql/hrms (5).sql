...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 18, 2026 at 12:29 PM
...
CREATE TABLE IF NOT EXISTS `attendances` (
  ...
  `date` date NOT NULL,
  `sign_in` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sign_out` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `is_corrected` enum('yes','no') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'no' COMMENT 'manual correction applied or not',
...
CREATE TABLE IF NOT EXISTS `documents` (
  ...
  `file_path` varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(26, 7, 'id_proof', 'employees/7/idProof_1773661434_6TAJARkI.png', '2026-03-16 11:43:56', '2026-03-16 11:43:56', NULL),
(27, 7, 'address_proof', 'employees/7/addressProof_1773661436_KQ3DmgSE.png', '2026-03-16 11:43:56', '2026-03-16 11:43:56', NULL),
(28, 7, 'bank_details', 'employees/7/bankDetails_1773661436_gcJyLO9P.png', '2026-03-16 11:43:56', '2026-03-16 11:43:56', NULL),
(29, 7, 'contract_letter', 'employees/7/contractLetter_1773661436_8BJbfTgp.png', '2026-03-16 11:43:56', '2026-03-16 11:43:56', NULL),
(30, 7, 'profile_image', 'employees/7/profileImage_1773661436_GNILdZRj.png', '2026-03-16 11:43:56', '2026-03-16 11:43:56', NULL);
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `aadhar_number` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `status` enum('active','inactive','terminated') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'active',
  `week_off` varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `employees` (`id`, `employee_code`, `first_name`, `last_name`, `blood_group`, `aadhar_number`, `mobile`, `email`, `department_id`, `shift_id`, `date_of_joining`, `employment_type`, `designation_id`, `status`, `week_off`, `address`, `zip_code`, `city`, `state`, `source`, `created_at`, `updated_at`, `deleted_at`, `user_id`) VALUES
(2, 'EMP2600001', 'Aman', 'Kumar', 'A-', '985647123025', '9135913699', 'aman@gmail.com', 1, 4, '2026-02-16', 1, '1', 'active', '0', 'Patna Bihar 8015030', 800001, 'patna', 'Bihar', NULL, '2026-02-16 09:15:51', '2026-02-24 10:36:43', NULL, NULL),
(3, 'EMP2600002', 'Rima', 'Kumari', 'A+', '985632147521', '9834567890', 'rima@gmail.com', 1, 1, '2026-02-16', 1, '1', 'active', '0', NULL, NULL, NULL, NULL, NULL, '2026-02-16 09:28:05', '2026-02-16 09:28:05', NULL, NULL),
(4, 'EMP2600003', 'Ramesh', 'Roy', 'O+', '985632147521', '9843234342', 'ramesh@gmail.com', 1, 2, '2026-02-16', 1, '2', 'active', '0', 'Patna Bihar', NULL, 'patna', 'Bihar', 'online', '2026-02-16 09:43:08', '2026-02-24 10:53:23', NULL, NULL),
(5, 'EMP2600004', 'Lala', 'Ram', 'B-', '985632147521', '9134913699', 'lala@gmail.com', 4, 1, NULL, 1, '3', 'active', '0', 'Patna Bihar', 800001, 'Patna', 'Bihar', 'walk-in', '2026-02-16 09:46:39', '2026-02-16 10:04:40', NULL, NULL),
(6, 'EMP2600005', 'Amar', 'Naath', 'B+', '362541789012', '9856321047', 'amar@gmail.com', 3, 3, '2026-03-06', 1, '2', 'active', NULL, 'patna bihar 801503', 800001, 'Patna', 'Bihar', 'referral', '2026-03-06 05:11:28', '2026-03-09 06:26:24', NULL, 33),
(7, 'EMP2600006', 'Rekha', 'Ram', 'A-', '985476321021', '7845123692', 'rekha@gmail.com', 4, 3, NULL, 1, '3', 'active', NULL, 'Patna Bihar 8015030', 800001, 'patna', 'Bihar', 'referral', '2026-03-16 11:43:54', '2026-03-17 09:16:19', NULL, 35);
...
CREATE TABLE IF NOT EXISTS `employee_salaries` (
  ...
  `pf_amount` decimal(10,0) DEFAULT NULL,
  `esic_applicable` tinyint(1) NOT NULL DEFAULT '0',
  `esic_amount` decimal(10,0) DEFAULT NULL,
  `status` enum('active','inactive') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'active',
  `uan_number` varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `esic_number` varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `employee_salaries` (`id`, `employee_id`, `basic_salary`, `hra`, `medical`, `conveyance_allowance`, `special_allowance`, `overtime_rate`, `pf_applicable`, `pf_amount`, `esic_applicable`, `esic_amount`, `status`, `uan_number`, `esic_number`, `effective_from`, `previous_salary`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 20000.00, 8000.00, 0.00, 0.00, 2000.00, 200.00, 1, NULL, 1, NULL, 'inactive', NULL, NULL, NULL, NULL, '2026-02-04 06:26:07', '2026-02-05 00:40:11', NULL),
(5, 1, 25000.00, 8000.00, 0.00, 0.00, 3000.00, 150.00, 1, NULL, 1, NULL, 'active', '123456789012', 'ESIC987654321', '2025-04-01', '{\"hra\": \"8000.00\", \"pf_amount\": null, \"uan_number\": null, \"esic_amount\": null, \"esic_number\": null, \"basic_salary\": \"20000.00\", \"gross_salary\": null, \"overtime_rate\": \"200.00\", \"pf_applicable\": 1, \"effective_from\": null, \"esic_applicable\": 1, \"medical_allowance\": null, \"special_allowance\": \"2000.00\"}', '2026-02-05 00:40:11', '2026-02-05 00:40:11', NULL),
(6, 5, 17000.00, 2100.00, 0.00, 0.00, 2000.00, 0.00, 1, NULL, 0, NULL, 'active', NULL, NULL, NULL, 'null', '2026-02-16 10:49:43', '2026-02-16 10:49:43', NULL),
(7, 3, 12000.00, 0.00, 0.00, 0.00, 399.00, 0.00, 0, NULL, 1, NULL, 'active', NULL, NULL, NULL, 'null', '2026-02-16 11:35:56', '2026-02-16 11:35:56', NULL),
(8, 4, 15000.00, 0.00, 0.00, 0.00, 500.00, 0.00, 1, NULL, 1, NULL, 'active', NULL, NULL, NULL, 'null', '2026-02-19 04:24:00', '2026-02-19 04:24:00', NULL),
(9, 2, 25000.00, 5000.00, 0.00, 0.00, 0.00, 0.00, 1, NULL, 0, NULL, 'inactive', NULL, NULL, NULL, 'null', '2026-02-19 04:24:37', '2026-02-19 04:32:18', NULL),
(10, 2, 25000.00, 5000.00, 0.00, 0.00, 2000.00, 0.00, 1, NULL, 0, NULL, 'inactive', NULL, NULL, NULL, '{\"hra\": \"5000.00\", \"pf_amount\": null, \"uan_number\": null, \"esic_amount\": null, \"esic_number\": null, \"basic_salary\": \"25000.00\", \"gross_salary\": null, \"overtime_rate\": \"0.00\", \"pf_applicable\": 1, \"effective_from\": null, \"esic_applicable\": 0, \"medical_allowance\": null, \"special_allowance\": \"0.00\"}', '2026-02-19 04:32:18', '2026-02-19 04:43:43', NULL),
(11, 2, 25000.00, 5000.00, 0.00, 0.00, 2000.00, 0.00, 1, NULL, 0, NULL, 'inactive', NULL, NULL, NULL, '{\"hra\": \"5000.00\", \"pf_amount\": null, \"uan_number\": null, \"esic_amount\": null, \"esic_number\": null, \"basic_salary\": \"25000.00\", \"gross_salary\": null, \"overtime_rate\": \"0.00\", \"pf_applicable\": 1, \"effective_from\": null, \"esic_applicable\": 0, \"medical_allowance\": null, \"special_allowance\": \"2000.00\", \"conveyance_allowance\": \"0.00\"}', '2026-02-19 04:43:43', '2026-02-19 04:56:24', NULL),
(12, 2, 25000.00, 5000.00, 3000.00, 1000.00, 2000.00, 0.00, 1, NULL, 0, NULL, 'inactive', NULL, NULL, NULL, '{\"hra\": \"5000.00\", \"medical\": null, \"pf_amount\": null, \"uan_number\": null, \"esic_amount\": null, \"esic_number\": null, \"basic_salary\": \"25000.00\", \"gross_salary\": null, \"overtime_rate\": \"0.00\", \"pf_applicable\": 1, \"effective_from\": null, \"esic_applicable\": 0, \"special_allowance\": \"2000.00\", \"conveyance_allowance\": \"0.00\"}', '2026-02-19 04:56:24', '2026-02-19 04:56:39', NULL),
(13, 2, 25000.00, 5000.00, 3000.00, 0.00, 2000.00, 0.00, 1, NULL, 0, NULL, 'active', NULL, NULL, NULL, '{\"hra\": \"5000.00\", \"medical\": null, \"pf_amount\": null, \"uan_number\": null, \"esic_amount\": null, \"esic_number\": null, \"basic_salary\": \"25000.00\", \"gross_salary\": null, \"overtime_rate\": \"0.00\", \"pf_applicable\": 1, \"effective_from\": null, \"esic_applicable\": 0, \"special_allowance\": \"2000.00\", \"conveyance_allowance\": \"1000.00\"}', '2026-02-19 04:56:39', '2026-02-19 04:56:39', NULL),
(14, 7, 17000.00, 2100.00, 3000.00, 1799.00, 2000.00, 0.00, 0, 3000, 0, 0, 'active', NULL, NULL, NULL, 'null', '2026-03-17 09:07:19', '2026-03-17 09:07:19', NULL);
...
(24, 3, 7, NULL, NULL, 1, 'active', '2026-03-16 11:43:56', '2026-03-16 11:43:56', NULL);
...
CREATE TABLE IF NOT EXISTS `finalized_payrolls` (
  ...
  `action_by` int DEFAULT NULL,
  `attendance_approval_status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `pf_calculation_status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `esic_calculation_status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `payslip_generation_status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `compliance_status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `management_approval_status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
(2, 'default', '{\"uuid\":\"ab42eedf-2011-406a-a1ea-a99b0c49fd8a\",\"displayName\":\"App\\\\Mail\\\\OnboardingMail\",\"job\":\"Illuminate\\\\Queue\\\\CallQueuedHandler@call\",\"maxTries\":null,\"maxExceptions\":null,\"failOnTimeout\":false,\"backoff\":null,\"timeout\":null,\"retryUntil\":null,\"data\":{\"commandName\":\"Illuminate\\\\Mail\\\\SendQueuedMailable\",\"command\":\"O:34:\\\"Illuminate\\\\Mail\\\\SendQueuedMailable\\\":17:{s:8:\\\"mailable\\\";O:23:\\\"App\\\\Mail\\\\OnboardingMail\\\":3:{s:8:\\\"employee\\\";O:45:\\\"Illuminate\\\\Contracts\\\\Database\\\\ModelIdentifier\\\":5:{s:5:\\\"class\\\";s:19:\\\"App\\\\Models\\\\Employee\\\";s:2:\\\"id\\\";i:7;s:9:\\\"relations\\\";a:0:{}s:10:\\\"connection\\\";s:5:\\\"mysql\\\";s:15:\\\"collectionClass\\\";N;}s:2:\\\"to\\\";a:1:{i:0;a:2:{s:4:\\\"name\\\";N;s:7:\\\"address\\\";s:15:\\\"rekha@gmail.com\\\";}}s:6:\\\"mailer\\\";s:4:\\\"smtp\\\";}s:5:\\\"tries\\\";N;s:7:\\\"timeout\\\";N;s:13:\\\"maxExceptions\\\";N;s:17:\\\"shouldBeEncrypted\\\";b:0;s:10:\\\"connection\\\";N;s:5:\\\"queue\\\";N;s:12:\\\"messageGroup\\\";N;s:12:\\\"deduplicator\\\";N;s:5:\\\"delay\\\";N;s:11:\\\"afterCommit\\\";N;s:10:\\\"middleware\\\";a:0:{}s:7:\\\"chained\\\";a:0:{}s:15:\\\"chainConnection\\\";N;s:10:\\\"chainQueue\\\";N;s:19:\\\"chainCatchCallbacks\\\";N;s:3:\\\"job\\\";N;}\"},\"createdAt\":1773661443,\"delay\":null}', 0, NULL, 1773661444, 1773661444);
...
CREATE TABLE IF NOT EXISTS `leaves` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `employee_id` bigint UNSIGNED NOT NULL,
  `leave_type` varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `rejected_reason` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `mail_logs` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `mail_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mailable_id` bigint UNSIGNED DEFAULT NULL,
  `mailable_type` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(19, '2026_03_09_123057_create_permission_tables', 2);
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `notifiable_type` enum('employee','user') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `date` date NOT NULL,
  `transaction_id` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remarks` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `payrolls` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `employee_id` bigint UNSIGNED NOT NULL,
  `status` enum('generated','processed','paid') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'generated',
  `month` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `year` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `is_mail_sent` enum('0','1') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  `mail_sent_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `is_paid` enum('0','1') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `permissions` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `module` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `permissions` (`id`, `name`, `guard_name`, `created_at`, `updated_at`, `module`) VALUES
(21, 'user.read', 'api', '2026-03-17 09:42:56', '2026-03-17 09:42:56', 'user'),
(22, 'attendance_correction.create', 'api', '2026-03-17 09:43:10', '2026-03-17 09:43:10', 'attendance_correction'),
(23, 'attendance_correction.read', 'api', '2026-03-17 09:43:10', '2026-03-17 09:43:10', 'attendance_correction'),
(24, 'attendance_correction.update', 'api', '2026-03-17 09:43:10', '2026-03-17 09:43:10', 'attendance_correction'),
(25, 'attendance_correction.delete', 'api', '2026-03-17 09:43:10', '2026-03-17 09:43:10', 'attendance_correction'),
(26, 'time_tracking.create', 'api', '2026-03-17 09:44:25', '2026-03-17 09:44:25', 'time_tracking'),
(27, 'time_tracking.read', 'api', '2026-03-17 09:44:25', '2026-03-17 09:44:25', 'time_tracking'),
(28, 'time_tracking.update', 'api', '2026-03-17 09:44:25', '2026-03-17 09:44:25', 'time_tracking'),
(29, 'time_tracking.delete', 'api', '2026-03-17 09:44:25', '2026-03-17 09:44:25', 'time_tracking'),
(30, 'document_template.create', 'api', '2026-03-17 09:52:51', '2026-03-17 09:52:51', 'document_template'),
(31, 'document_template.read', 'api', '2026-03-17 09:52:51', '2026-03-17 09:52:51', 'document_template'),
(32, 'document_template.update', 'api', '2026-03-17 09:52:51', '2026-03-17 09:52:51', 'document_template'),
(33, 'document_template.delete', 'api', '2026-03-17 09:52:51', '2026-03-17 09:52:51', 'document_template'),
(34, 'department.create', 'api', '2026-03-17 09:53:01', '2026-03-17 09:53:01', 'department'),
(35, 'department.read', 'api', '2026-03-17 09:53:01', '2026-03-17 09:53:01', 'department'),
(36, 'department.update', 'api', '2026-03-17 09:53:01', '2026-03-17 09:53:01', 'department'),
(37, 'department.delete', 'api', '2026-03-17 09:53:02', '2026-03-17 09:53:02', 'department'),
(38, 'designation.create', 'api', '2026-03-17 09:53:26', '2026-03-17 09:53:26', 'designation'),
(39, 'designation.read', 'api', '2026-03-17 09:53:26', '2026-03-17 09:53:26', 'designation'),
(40, 'designation.update', 'api', '2026-03-17 09:53:26', '2026-03-17 09:53:26', 'designation'),
(41, 'designation.delete', 'api', '2026-03-17 09:53:26', '2026-03-17 09:53:26', 'designation'),
(42, 'employee_payroll_history.read', 'api', '2026-03-17 09:55:13', '2026-03-17 09:55:13', 'employee_payroll_history'),
(43, 'payroll_processing.create', 'api', '2026-03-17 09:55:30', '2026-03-17 09:55:30', 'payroll_processing'),
(44, 'payroll_processing.read', 'api', '2026-03-17 09:55:30', '2026-03-17 09:55:30', 'payroll_processing'),
(45, 'payroll_processing.update', 'api', '2026-03-17 09:55:30', '2026-03-17 09:55:30', 'payroll_processing'),
(46, 'payroll_processing.delete', 'api', '2026-03-17 09:55:30', '2026-03-17 09:55:30', 'payroll_processing'),
(47, 'payroll_finalization.create', 'api', '2026-03-17 09:55:41', '2026-03-17 09:55:41', 'payroll_finalization'),
(48, 'payroll_finalization.read', 'api', '2026-03-17 09:55:41', '2026-03-17 09:55:41', 'payroll_finalization'),
(49, 'payroll_finalization.update', 'api', '2026-03-17 09:55:41', '2026-03-17 09:55:41', 'payroll_finalization'),
(50, 'payroll_finalization.delete', 'api', '2026-03-17 09:55:41', '2026-03-17 09:55:41', 'payroll_finalization'),
(51, 'roles_permission.create', 'api', '2026-03-17 09:55:52', '2026-03-17 09:55:52', 'roles_permission'),
(52, 'roles_permission.read', 'api', '2026-03-17 09:55:52', '2026-03-17 09:55:52', 'roles_permission'),
(53, 'roles_permission.update', 'api', '2026-03-17 09:55:52', '2026-03-17 09:55:52', 'roles_permission'),
(54, 'roles_permission.delete', 'api', '2026-03-17 09:55:52', '2026-03-17 09:55:52', 'roles_permission'),
(55, 'staff_directory.create', 'api', '2026-03-17 09:56:03', '2026-03-17 09:56:03', 'staff_directory'),
(56, 'staff_directory.read', 'api', '2026-03-17 09:56:03', '2026-03-17 09:56:03', 'staff_directory'),
(57, 'staff_directory.update', 'api', '2026-03-17 09:56:03', '2026-03-17 09:56:03', 'staff_directory'),
(58, 'staff_directory.delete', 'api', '2026-03-17 09:56:03', '2026-03-17 09:56:03', 'staff_directory'),
(59, 'salary_structure_revision.create', 'api', '2026-03-17 09:56:13', '2026-03-17 09:56:13', 'salary_structure_revision'),
(60, 'salary_structure_revision.read', 'api', '2026-03-17 09:56:14', '2026-03-17 09:56:14', 'salary_structure_revision'),
(61, 'salary_structure_revision.update', 'api', '2026-03-17 09:56:14', '2026-03-17 09:56:14', 'salary_structure_revision'),
(62, 'salary_structure_revision.delete', 'api', '2026-03-17 09:56:14', '2026-03-17 09:56:14', 'salary_structure_revision'),
(63, 'setting.create', 'api', '2026-03-17 09:57:04', '2026-03-17 09:57:04', 'setting'),
(64, 'setting.read', 'api', '2026-03-17 09:57:04', '2026-03-17 09:57:04', 'setting'),
(65, 'setting.update', 'api', '2026-03-17 09:57:04', '2026-03-17 09:57:04', 'setting'),
(66, 'setting.delete', 'api', '2026-03-17 09:57:04', '2026-03-17 09:57:04', 'setting'),
(67, 'shift.create', 'api', '2026-03-17 09:57:14', '2026-03-17 09:57:14', 'shift'),
(68, 'shift.read', 'api', '2026-03-17 09:57:14', '2026-03-17 09:57:14', 'shift'),
(69, 'shift.update', 'api', '2026-03-17 09:57:14', '2026-03-17 09:57:14', 'shift'),
(70, 'shift.delete', 'api', '2026-03-17 09:57:14', '2026-03-17 09:57:14', 'shift'),
(71, 'user.create', 'api', '2026-03-17 09:57:24', '2026-03-17 09:57:24', 'user'),
(72, 'user.update', 'api', '2026-03-17 09:57:24', '2026-03-17 09:57:24', 'user'),
(73, 'user.delete', 'api', '2026-03-17 09:57:24', '2026-03-17 09:57:24', 'user');
...
(2, 'Admin', 'api', '2026-02-04 05:56:19', '2026-02-04 05:57:57', NULL, 1);
...
('7Qj44fmU5ci1NHpp3Pwo7Y1SjBx49ZrJVNmbFVzh', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '', 1772799449);
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `theme_color` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `copyright` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `powered_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `api_key` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `templates` (
  ...
  `subject` varchar(191) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `status` enum('active','inactive') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `token`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'sumit kumar', 'admin@techiesquad.com', NULL, '$2y$12$PxFMDlNHVITYamgLuFBDYOHqWgcQDhvq.7rdr2Ir3HUTrcTsq.T5q', '1f04a5d6df7bfc04326d0c32b179431942b9dbc2d2b621404dd75fb685a2154a', NULL, NULL, NULL, NULL, NULL, NULL, '1', '2026-02-02 06:56:35', '2026-03-17 07:31:36', NULL),
(33, 'Aman Kumar', 'aman@gmail.com', NULL, '$2y$12$OjmoVcY9zBIZ9jlmxDFXbO0B5LSTZMnEoNmnUTZ53QP/MynpQMdKi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', '2026-02-16 09:15:51', '2026-03-17 09:16:10', NULL),
(35, 'Rekha Ram', 'rekha@gmail.com', NULL, '$2y$12$PxFMDlNHVITYamgLuFBDYOHqWgcQDhvq.7rdr2Ir3HUTrcTsq.T5q', 'cb5630d1f81bdefdaa85b64dee1d8556d3fc21b84acab9705262855d2db2ff17', NULL, NULL, NULL, NULL, NULL, NULL, '1', '2026-03-16 11:43:54', '2026-03-17 07:30:53', NULL);
